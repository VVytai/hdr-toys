...
// images generated by Annex C.3.8. In this non-normative ICtCp variant, the
// max-component gain curve is driven by decoded ICtCp intensity and the mapped
// intensity is encoded back to PQ before correcting Ct/Cp.
